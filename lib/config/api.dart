...
class Api {
  ...
  static String get warState => '$base/api/war-state';
}
...
class PollIntervals {
  ...
  static const Duration warState = Duration(minutes: 10);
}
...
class CacheTtl {
  ...
  static const Duration defenseStats = Duration(minutes: 5);
  static const Duration briefing = Duration(minutes: 30);
